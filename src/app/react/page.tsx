          ...
          <div className="max-w-prose">
            ...
            <section>
              ...
              <p className="text-justify">
                ...
                officiis iure ex possimus perferendis voluptatem sapiente
                ratione. Earum nostrum iure mollitia? Tempore, animi.
                Repudiandae distinctio dignissimos placeat, est facere maxime
                hic ullam dolores ducimus voluptate dolor. At minima provident
                labore explicabo animi, esse exercitationem amet maiores velit?
                Placeat, sapiente eius. Possimus quasi enim illum tempore magni
                architecto nesciunt!
              </p>
            </section>
            <section>
